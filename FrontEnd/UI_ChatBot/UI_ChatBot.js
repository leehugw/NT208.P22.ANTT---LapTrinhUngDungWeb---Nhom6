...
async function createNewSessionOnServer(firstMessage = '') {
  ...
  try {
    ...
    const res = await fetch('https://uit-chatbot-orno.onrender.com/api/student/chat-sessions', {
      method: 'POST',
      headers: {
...
async function sendMessage() {
    ...
    try {
        ...
        const userMessageRes = await fetch(`https://uit-chatbot-orno.onrender.com/api/student/chat-sessions/${currentSessionId}/messages`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
        ...
        const botRes = await fetch(`https://uit-chatbot-orno.onrender.com/api/student/chatbot-data`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
        ...
        const botMessageRes = await fetch(`https://uit-chatbot-orno.onrender.com/api/student/chat-sessions/${currentSessionId}/messages`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${token}`
...
async function loadSessionToChatBox(sessionId) {
    ...
    try {
        const res = await fetch(`https://uit-chatbot-orno.onrender.com/api/student/chat-sessions/${sessionId}`, {
